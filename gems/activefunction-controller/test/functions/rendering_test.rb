...
class RenderingTestFunction
  ...
  include ActiveFunction::Controller::Rendering
...
class DoubleRenderTest < Minitest::Test
  ...
  def test_double_render
    assert_raises ActiveFunction::Controller::DoubleRenderError do
      @function.dispatch(:index, {}, response)
    end
  end
end
...
class NotRenderedTest < Minitest::Test
  ...
  def test_not_rendered
    assert_raises ActiveFunction::Controller::NotRenderedError do
      @function.dispatch(:index, {}, response)
    end
  end
end
