...
class StrongParametersFunction
  include ActiveFunction::Controller::Core
  include ActiveFunction::Controller::StrongParameters
end
...
class StrongParametersTest < Minitest::Test
  ...
  def test_params
    assert_instance_of ActiveFunction::Controller::StrongParameters::Parameters, @function.params
  end
end

describe ActiveFunction::Controller::StrongParameters::Parameters do
  let(:described_class) { ::ActiveFunction::Controller::StrongParameters::Parameters }
  ...
  describe "#require" do
    ...
    it "raises a ParameterMissingError when the parameter does not exist" do
      ...
      assert_raises(ActiveFunction::Controller::ParameterMissingError) { params.require(:name) }
    end
  end
  ...
  describe "#to_h" do
    ...
    it "raises UnpermittedParameterError when some parameter is not permitted" do
      ...
      assert_raises(ActiveFunction::Controller::UnpermittedParameterError) { params.to_h }
    end
  end
end
